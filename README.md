...
The mod provides a startup setting which, when set, will replace all existing [Inventory Sensor](https://mods.factorio.com/mod/Inventory%20Sensor) entities with the Improved Inventory Sensor:
